...
namespace Classroom.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260508184827_AddCommentsRatingsCategories")]
    partial class AddCommentsRatingsCategories
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.CourseRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.LessonComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.Course", b =>
                {
                    b.HasOne("Classroom.Domain.Entities.Category", "Category")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Classroom.Domain.Entities.LessonComment", b =>
                {
                    ...
                    b.HasOne("Classroom.Domain.Entities.LessonComment", "Parent")
                        .WithMany("Replies")
